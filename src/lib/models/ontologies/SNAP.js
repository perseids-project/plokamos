...
class SNAP {
    ...
    static expand(type) { return _.result(expandMap,type,expandMap.default(type)) }
    static simplify(type) { return _.result(simplifyMap,type,simplifyMap.default(type)) }
