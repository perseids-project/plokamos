...
class View {
    ...
    constructor(ontology, activate, partials, view, validator) {
        ...
        self.updateValue = (event, text) => {
            var triple, token
            // react appropriately to paste events as well as keyboard action on the typeahead
        ...
        // view contains functions that are performed during the render process
        ...
        // partials are the markup for the views
        self.partials = Object.assign({},
            {
                ...
                // graph old is a container for annotations that existed before
                ...
                // grap new is for new annotations
...
class Plugin {
    ...
    constructor(app,config) {
        ...
        // shown.bs.popover event is issues by bootstrap whenever a bootstrap popover is shown
        // we append plugin-specific buttons to the popover
        ...
        $('body').on('click','.btn-'+this.constructor.name,(e) => {
            ...
            // origin holds a reference to previous annotations 
        ...
        this.apply = (event) => {
            ...
            // it will only be used if we actually are creating a new annotation
